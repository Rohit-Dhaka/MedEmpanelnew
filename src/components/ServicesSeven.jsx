    ...
    <section className="relative bg-white">
      ...
      <div className="container mx-auto px-4 pt-[80px]">
        <div className="flex flex-col items-center">
          ...
          <h6 className="max-w-[800px] text-lg text-[#323232] text-center pb-[80px] pt-6">
          ...
          <h3 className="text-2xl font-semibold text-center pt-10 pb-4 text-[#333]">What is National Insurance Hospital Empanelment?</h3>
          <p className="max-w-[900px] text-[#444] text-base text-center pb-4">
          ...
          <h3 className="text-2xl font-semibold text-center pt-10 pb-4 text-[#333]">About National Insurance</h3>
          <p className="max-w-[900px] text-[#444] text-base text-center pb-4">
          ...
          <h3 className="text-2xl font-semibold text-center pt-10 pb-4 text-[#333]">How to get Empanelled with National Insurance?</h3>
          <p className="max-w-[900px] text-[#444] text-base text-center pb-4">
          ...
          <ul className="list-disc text-left text-[#444] max-w-[800px] pl-6 pb-4">
          ...
          <p className="max-w-[900px] text-[#444] text-base text-center pb-[120px]">
